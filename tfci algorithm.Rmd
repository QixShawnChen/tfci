...
TODO: qreach needs a modification 
```{r}
...
change pdsep to "t-pdsep" (In progress)
 ...
 Need to write a program to avoid some specific d-sep. (In progress)
 (1)Type 1, conditioning set containing vertices in future tiers.
 
  *Need sometime to read FCI again to make correct modifications for the collider things.
```{r}
...
1. Need to modify the "legal" to "t-legal"; (In progress)
```{r}
