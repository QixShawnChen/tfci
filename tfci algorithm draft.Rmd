...
change pdsep to "t-pdsep" (In progress) Mark biCC parameter done Need to check if the possible d-seps follow the temporal rules: trying to add a "tier" parameter to work as a control rule. 
